export default {
  ...
  subtitle: 'Genereer professionele README-bestanden voor je Pelican Eggs',
  ...
  eggName: 'Egg Naam *',
  eggNamePlaceholder: 'bijv. Minecraft',
  ...
  steamAppIdPlaceholder: 'bijv. 730 (haalt data automatisch op)',
  ...
  javaVersionPlaceholder: 'bijv. Java 17',
  minecraftVersion: 'Ondersteunde Minecraft Versies',
  minecraftVersionPlaceholder: 'bijv. 1.20.x, 1.19.x',
  ...
  portDescriptionPlaceholder: 'bijv. Server vereist tot 4 poorten',
  portNamePlaceholder: 'Poortnaam (bijv. Game)',
  portValuePlaceholder: 'Poort (bijv. 25565)',
  addPort: '+ Poort toevoegen',
  portWarning: 'Poortwaarschuwing (optioneel)',
  portWarningPlaceholder: 'bijv. Het wijzigen van de gamepoort van 7777 maakt de server onbereikbaar!',
  
  // Recommended Settings
  recommendedSettings: '💻 Aanbevolen Instellingen',
  minRam: 'Minimum RAM',
  minRamPlaceholder: 'bijv. 4096M',
  minCpu: 'Minimum CPU',
  minCpuPlaceholder: 'bijv. 2 Cores',
  minDisk: 'Minimum Schijfruimte',
  minDiskPlaceholder: 'bijv. 10GB',
  ...
  linkTextPlaceholder: 'Linktekst (bijv. Wiki)',
  ...
  authorNamePlaceholder: 'bijv. Jan Jansen',
  ...
  customLicensePlaceholder: 'bijv. Propriëtaire Licentie',
